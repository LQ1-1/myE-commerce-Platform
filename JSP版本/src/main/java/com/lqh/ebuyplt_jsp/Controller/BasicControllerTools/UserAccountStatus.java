package com.lqh.ebuyplt_jsp.Controller.BasicControllerTools;
...
public class UserAccountStatus
{
    ...
    //字符串到枚举的映射
    public HashMap<String, UserAccountStatus.UserAccountStatusEnum> StringToEnum=new HashMap<String, UserAccountStatus.UserAccountStatusEnum>(
            Map.ofEntries(
    ...
    //枚举到字符串的映射
    public HashMap<UserAccountStatus.UserAccountStatusEnum,String> EnumToString=new HashMap<UserAccountStatus.UserAccountStatusEnum,String>(
            Map.ofEntries(
