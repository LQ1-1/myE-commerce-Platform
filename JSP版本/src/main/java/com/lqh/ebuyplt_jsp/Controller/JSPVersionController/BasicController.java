...
import com.lqh.ebuyplt_jsp.Controller.AdminPack.AdminStatus;
import com.lqh.ebuyplt_jsp.Controller.AdminPack.UserAccountTableItem;
import com.lqh.ebuyplt_jsp.Controller.AdminPack.UserDeliveryInfoTableItem;
import com.lqh.ebuyplt_jsp.Controller.BasicControllerTools.UserAccountStatus;
import com.lqh.ebuyplt_jsp.Controller.BasicControllerTools.UserAccountType;
import com.lqh.ebuyplt_jsp.Controller.DBTools.DBUtil;
import com.lqh.ebuyplt_jsp.Controller.JSONparameter.UserLogin;
import com.lqh.ebuyplt_jsp.Controller.JSONparameter.UserRegistration;
...
//        System.out.println("获取信息:"+UserPassword);
    ...
    @POST
    @Path("/UserAccountTableUpdate")
    @Produces("text/plain")
    public String  UserAccountTableUpdate(UserAccountTableItem newInfo)     //更新UserAccount信息的接口
    {
    ...
    @POST
    @Path("/SetUserDeliveryInfo")
    @Produces("text/plain")
    public String SetUserDeliveryInfo(UserDeliveryInfoTableItem para)     //更新其中一个收货信息,需要填写uID,uDIndex来确定具体是要删除哪一个记录
    {
    ...
    @POST
    @Path("/AddUserDeliveryInfo")
    @Produces("text/plain")
    public String AddUserDeliveryInfo(UserDeliveryInfoTableItem para)      //新增一个收货信息,uDIndex不用填写
    {
        return AddUserDeliveryInfoResult(para)?AdminStatus.Success:AdminStatus.Fail;
    }
    private boolean AddUserDeliveryInfoResult(UserDeliveryInfoTableItem para)
    {
        boolean res=false;
        try
        {
    ...
    @POST
    @Path("/DeleteUserDeliveryInfo")
    @Produces("text/plain")
    public String DeleteUserDeliveryInfo(UserDeliveryInfoTableItem para)   //删除其中的一个收货记录，需要填写uID,uDIndex来标定具体一个记录
    {
