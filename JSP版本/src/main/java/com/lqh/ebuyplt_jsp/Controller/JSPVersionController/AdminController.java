...
import com.lqh.ebuyplt_jsp.Controller.AdminPack.*;
import com.lqh.ebuyplt_jsp.Controller.DBTools.DBUtil;
import com.lqh.ebuyplt_jsp.Controller.MerchantPack.ProductImageItem;
import com.lqh.ebuyplt_jsp.Controller.MerchantPack.ProductInfoUpdate_jsonGet;
import com.lqh.ebuyplt_jsp.Controller.ResultPack.ApiResult;
import com.lqh.ebuyplt_jsp.Controller.UIControllerTools.ProductSearch_jsonGet;
...
public class AdminController
{
    ...
    @GET
    @Path("/AdminUserDeliveryInfoTable")
    @Produces("application/json")
    ...
    @GET
    @Path("/AdminUserShoppingCartTable")
    @Produces("application/json")
    ...
    @GET
    @Path("/AdminMerchantsProductTable")
    @Produces("application/json")
    ...
    @GET
    @Path("/AdminProductClicksInfoTable")
    @Produces("application/json")
    ...
    @GET
    @Path("/AdminOrderProductInfoTable")
    @Produces("application/json")
...
//                    "LOWER(pInfo) LIKE LOWER(?);";                                                                      //商品描述信息
    ...
    @POST
    @Path("/AdminUserAccountTableUpdate")
    @Produces("text/plain")
    public String  AdminUserAccountTableUpdate(UserAccountTableItem newInfo)     //更新UserAccountTable的接口
    {
    ...
    @POST
    @Path("/UserDeliveryInfoTableUpdate")
    @Produces("text/plain")
    public String UserDeliveryInfoTableUpdate(UserDeliveryInfoTableItem newInfo)   //更新收货信息的接口
    {
    ...
    @POST
    @Path("/AdminUserDeliveryInfoTableAdd")
    @Produces("text/plain")
    public String AdminUserDeliveryInfoTableAdd(UserDeliveryInfoTableItem para)        //uDIndex不用填写
    {
    ...
    @POST
    @Path("/AdminUserDeliveryInfoTableDelete")
    @Produces("text/plain")
    public String AdminUserDeliveryInfoTableDelete(UserDeliveryInfoTableItem para)     //需要填写uID,uDIndex来标定一个具体收货信息记录
    {
    ...
    private String saveFile(Part file, String saveDir, String pID) throws IOException    //返回加工过的文件名，函数里面将图片文件保存至磁盘里面
    {
        String originalFilename = file.getSubmittedFileName();//文件名(带后缀)
        ...
        {
            Files.copy(inputStream,Paths.get(saveDir+newFileName), StandardCopyOption.REPLACE_EXISTING);
        }
    ...
    @POST
    @Path("/AdminOrderBasicInfoTableUpdate")
    @Produces("text/plain")
    public String AdminOrderBasicInfoTableUpdate(OrderFullInfoTableItem para)
    {
    ...
    @POST
    @Path("/AdminOrderProductInfoTableUpdate")
    @Produces("text/plain")
    public String AdminOrderProductInfoTableUpdate(OrderProductInfoTableItem para)
    {
