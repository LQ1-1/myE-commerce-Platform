...
import com.lqh.ebuyplt_jsp.Controller.FavouritePack.*;
import com.lqh.ebuyplt_jsp.Controller.ResultPack.ApiResult;
import com.lqh.ebuyplt_jsp.Controller.ShoppingCartPack.*;
...
public class ShoppingCartController
{
    ...
    //添加到购物车模块
    @POST
    @Path("/ShoppingCartAdd")
    @Produces("text/plain")
    public String ShoppingCartAdd(ShoppingCartAdd_jsonGet shoppingCartAdd)
    {
    ...
    @POST
    @Path("/ShoppingCartRemove")
    public void ShoppingCartRemove(ShoppingCartRemove_jsonGet shoppingCartRemove)//单个移除
    {
    ...
    @POST
    @Path("/ShoppingCartMultipleRemove")
    public void ShoppingCartMultipleRemove(ShoppingCartMultipleRemove_jsonGet shoppingCartMultipleRemove)
    {
    ...
    @Path("/FavouriteAdd")
    @Produces("text/plain")
    public String FavouriteAdd(FavouriteAdd_jsonGet favouriteAdd)
    {
    ...
    @POST
    @Path("/FavouriteRemove")
    public void FavouriteRemove(FavouriteRemove_jsonGet favouriteRemove)//单个移除
    {
    ...
    @POST
    @Path("/FavouriteMultipleRemove")
    public void FavouriteMultipleRemove(FavouriteMultipleRemove_jsonGet favouriteMultipleRemove)
    {
